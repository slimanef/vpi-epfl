xquery version "1.0";
(: --------------------------------------
   vpi-epfl application

   Creator: Stéphane Sire <s.sire@oppidoc.fr>         
   modified by: fouad Slimane <fouad.slimane@egmail.com>
...
(: ======================================================================
   Converts <site:logo> static image link
   ======================================================================
:)
declare function site:logo($cmd as element()) as element()* {
    partial:logo($cmd)
};
...
declare function site:navigation($cmd as element(), $view as element()) as element()*
{
    ...
    return
        <ul
            ...
            <li>{local:gen-nav-class($name, 'accounts', ())}<a
                    href="{$base}."
                    loc="app.nav.accounts">Accounts</a></li>
            <li>{local:gen-nav-class($name, 'contacts', ())}<a
                    href="{$base}."
                    loc="app.nav.contacts">Contacts</a></li>
            
            <li>{local:gen-nav-class($name, 'projects', ())}<a
                    href="{$base}."
                    loc="app.nav.projects">Projects</a></li>
            <li>{local:gen-nav-class($name, 'events', ())}<a
                    href="{$base}."
                    loc="app.nav.events">Events</a></li>
            
            <li>{local:gen-nav-class($name, 'reporting', ())}<a
                    href="{$base}."
                    loc="app.nav.reporting">Reporting</a></li>
            
            
            <!--<li>
        { local:gen-nav-class($name, ('persons', 'enterprises'), 'dropdown') }
        <a class="dropdown-toggle" data-toggle="dropdown" href="#" loc="app.nav.communities">Network</a>
        <ul class="dropdown-menu">
          <li><a href="{$base}persons" loc="app.nav.contacts">Contacts</a></li>
          <li><a href="{$base}enterprises" loc="app.nav.enterprises">Companies</a></li>
        </ul>
      </li>
      <li>
        { local:gen-nav-class($name, (), 'dropdown') }
        <a class="dropdown-toggle" data-toggle="dropdown" href="#" loc="app.nav.projects">Projects</a>
        <ul class="dropdown-menu">
          <li><a href="http://knowledge-portal.ch">KnowledgePortal</a></li>
          <li><a href="https://coachmatch-smei.easme-web.eu/">CoachMatch</a></li>
          <li><a href="https://matchinvest.ch/">matchINVEST</a></li>
        </ul>
      </li>
      {
...
(:           $person := concat(globals:collection('persons-uri')//Person[UserProfile/Username =$user]/Name/FirstName, ' ', globals:collection('persons-uri')//Person[UserProfile/Username =$user]/Name/LastName) 
:)
    return
        if ($user = 'guest') then
            ...
            return
                ...
                <a
                    ...
                    style="color:#8E8E8E;text-decoration:none">{$user}</a>,
                <a
                    class="login"
                    href="{$cmd/@base-url}logout?url={$cmd/@base-url}">LOGOUT</a>
                )
};
